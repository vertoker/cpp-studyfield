...
int main()
{
    ...
    // os
    std::cout << "pointer: " << sizeof(int*) << " bytes, " << sizeof(int*) * 8 << " bits" << std::endl;
    std::cout << "lvalue reference: " << sizeof(int&) << " bytes, " << sizeof(int&) * 8 << " bits" << std::endl;
    std::cout << "rvalue reference: " << sizeof(int&&) << " bytes, " << sizeof(int&&) * 8 << " bits" << std::endl;

    // arrays
    std::cout << "int array of 10: " << sizeof(int[10]) << " bytes, " << sizeof(int[10]) * 8 << " bits" << std::endl;
